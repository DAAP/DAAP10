...
#  This is DAAP10.1.2.py; it is based on DAAP09.6, it adds an
#  additional function: The construction of density functions based
#  on user defined segmentation.
...
for v in range(len(Files0)):
    ...
    if len(SplitFile) > 2:
        ...
        continue
    elif re.match('txt', SplitFile[1]) is not None:
